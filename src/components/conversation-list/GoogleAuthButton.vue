<template>
    <button @click="googleStatus.isAuthenticated ? emit('google-logout') : emit('google-login')"
        ...
        :title="googleStatus.isAuthenticated ? 'התנתק מגוגל' : 'התחבר עם Google לסנכרון אנשי קשר'">
...
const emit = defineEmits(['google-login', 'google-logout']);
</script>