  ...
  <div class="h-full">
    ...
    <div v-if="isLoading" class="fixed inset-0 bg-white flex justify-center items-center z-50">
      <div class="flex flex-col items-center">
        ...
        <p class="text-gray-600">התוכנה נטענת...</p>
      </div>
    </div>

    <!-- Main Application View -->
    <MainView v-if="!isLoading && !loginDialogVisible && username" :username="username" @logout="logout" />

    <!-- Login Dialog -->
    <LoginDialog :visible="loginDialogVisible && !isLoading" :should-focus="true" @login-success="handleLoginSuccess"
